...
public class CactoseDonate implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) throws IOException {
        ...
        response.append("<style type=\"text/css\">body {background-image: url(\"http://i.imgur.com/C6ekUXX.gif\");}</style>");
        response.append("<center>");
        response.append("<font size = '6' color = 'ffffff'>");
        response.append("donate to the original author of Grappl, <a href=\"https://twitter.com/Cactose\">Cactose</a><p>");
